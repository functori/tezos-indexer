...
data class Order(
    ...
    @field:JsonProperty("fill", required = true) val fill: String,

    @field:JsonProperty("makeStock", required = true) val makeStock: String,
    ...
    @field:JsonProperty("makeBalance") val makeBalance: String? = null,
