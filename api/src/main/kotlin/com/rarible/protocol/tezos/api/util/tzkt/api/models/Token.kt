...
data class Token (
    ...
    @Json(name = "firstTime")
    var firstTime: java.time.OffsetDateTime? = null,
    ...
    @Json(name = "lastTime")
    var lastTime: java.time.OffsetDateTime? = null,
