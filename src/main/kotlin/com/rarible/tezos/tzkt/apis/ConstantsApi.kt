...
import com.rarible.tezos.tzkt.models.Constant
...
class ConstantsApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun constantsGet(address: OneOfLessThanExpressionParameterGreaterThan?, creationLevel: OneOfLessThanInt32ParameterGreaterThan?, creationTime: OneOfLessThanTimestampParameterGreaterThan?, creator: OneOfLessThanAccountParameterGreaterThan?, refs: OneOfLessThanInt32ParameterGreaterThan?, size: OneOfLessThanInt32ParameterGreaterThan?, select: OneOfLessThanSelectParameterGreaterThan?, sort: OneOfLessThanSortParameterGreaterThan?, offset: OneOfLessThanOffsetParameterGreaterThan?, limit: kotlin.Int?, format: kotlin.Int?) : kotlin.collections.List<Constant> {
    ...
    */
    ...
    fun constantsGetWithHttpInfo(address: OneOfLessThanExpressionParameterGreaterThan?, creationLevel: OneOfLessThanInt32ParameterGreaterThan?, creationTime: OneOfLessThanTimestampParameterGreaterThan?, creator: OneOfLessThanAccountParameterGreaterThan?, refs: OneOfLessThanInt32ParameterGreaterThan?, size: OneOfLessThanInt32ParameterGreaterThan?, select: OneOfLessThanSelectParameterGreaterThan?, sort: OneOfLessThanSortParameterGreaterThan?, offset: OneOfLessThanOffsetParameterGreaterThan?, limit: kotlin.Int?, format: kotlin.Int?) : ApiResponse<kotlin.collections.List<Constant>?> {
    ...
    */
    fun constantsGetRequestConfig(address: OneOfLessThanExpressionParameterGreaterThan?, creationLevel: OneOfLessThanInt32ParameterGreaterThan?, creationTime: OneOfLessThanTimestampParameterGreaterThan?, creator: OneOfLessThanAccountParameterGreaterThan?, refs: OneOfLessThanInt32ParameterGreaterThan?, size: OneOfLessThanInt32ParameterGreaterThan?, select: OneOfLessThanSelectParameterGreaterThan?, sort: OneOfLessThanSortParameterGreaterThan?, offset: OneOfLessThanOffsetParameterGreaterThan?, limit: kotlin.Int?, format: kotlin.Int?) : RequestConfig<Unit> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun constantsGetCount(refs: OneOfLessThanInt32ParameterGreaterThan?) : kotlin.Int {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun constantsGetCountWithHttpInfo(refs: OneOfLessThanInt32ParameterGreaterThan?) : ApiResponse<kotlin.Int?> {
    ...
    * @return RequestConfig
    */
    fun constantsGetCountRequestConfig(refs: OneOfLessThanInt32ParameterGreaterThan?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                if (refs != null) {
