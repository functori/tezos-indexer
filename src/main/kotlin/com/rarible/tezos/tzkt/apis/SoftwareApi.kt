...
import com.rarible.tezos.tzkt.models.Software
...
class SoftwareApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    * @param sort Sorts delegators by specified field. Supported fields: &#x60;id&#x60; (default), &#x60;firstLevel&#x60;, &#x60;lastLevel&#x60;, &#x60;blocksCount&#x60;. (optional)
    ...
    * @return kotlin.collections.List<Software>
    ...
    */
    ...
    fun softwareGet(select: OneOfLessThanSelectParameterGreaterThan?, sort: OneOfLessThanSortParameterGreaterThan?, offset: OneOfLessThanOffsetParameterGreaterThan?, limit: kotlin.Int?) : kotlin.collections.List<Software> {
        val localVarResponse = softwareGetWithHttpInfo(select = select, sort = sort, offset = offset, limit = limit)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.collections.List<Software>
    ...
    * @param offset Specifies which or how many items should be skipped (optional)
    * @param limit Maximum number of items to return (optional, default to 100)
    * @return ApiResponse<kotlin.collections.List<Software>?>
    * @throws IllegalStateException If the request is not correctly configured
    * @throws IOException Rethrows the OkHttp execute method exception
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun softwareGetWithHttpInfo(select: OneOfLessThanSelectParameterGreaterThan?, sort: OneOfLessThanSortParameterGreaterThan?, offset: OneOfLessThanOffsetParameterGreaterThan?, limit: kotlin.Int?) : ApiResponse<kotlin.collections.List<Software>?> {
    ...
    /**
    * To obtain the request config of the operation softwareGet
    *
    * @param select Specify comma-separated list of fields to include into response or leave it undefined to return full object. If you select single field, response will be an array of values in both &#x60;.fields&#x60; and &#x60;.values&#x60; modes. (optional)
    * @param sort Sorts delegators by specified field. Supported fields: &#x60;id&#x60; (default), &#x60;firstLevel&#x60;, &#x60;lastLevel&#x60;, &#x60;blocksCount&#x60;. (optional)
    * @param offset Specifies which or how many items should be skipped (optional)
    ...
    */
    fun softwareGetRequestConfig(select: OneOfLessThanSelectParameterGreaterThan?, sort: OneOfLessThanSortParameterGreaterThan?, offset: OneOfLessThanOffsetParameterGreaterThan?, limit: kotlin.Int?) : RequestConfig<Unit> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun softwareGetCount() : kotlin.Int {
        val localVarResponse = softwareGetCountWithHttpInfo()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun softwareGetCountWithHttpInfo() : ApiResponse<kotlin.Int?> {
        val localVariableConfig = softwareGetCountRequestConfig()
    ...
    /**
    * To obtain the request config of the operation softwareGetCount
    *
    * @return RequestConfig
    */
    fun softwareGetCountRequestConfig() : RequestConfig<Unit> {
        val localVariableBody = null
