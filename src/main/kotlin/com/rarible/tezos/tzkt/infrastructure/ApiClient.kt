package com.rarible.tezos.tzkt.infrastructure
...
open class ApiClient(val baseUrl: String) {
    companion object {
        ...
        const val baseUrlKey = "com.rarible.tezos.tzkt.baseUrl"
    ...
    protected inline fun <reified T: Any?> responseBody(body: ResponseBody?, mediaType: String? = JsonMediaType): T? {
        ...
        if (T::class.java == File::class.java) {
            // return tempfile
            val f = java.nio.file.Files.createTempFile("tmp.com.rarible.tezos.tzkt", null).toFile()
            f.deleteOnExit()
