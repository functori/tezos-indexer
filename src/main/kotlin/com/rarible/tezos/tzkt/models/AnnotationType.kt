 ...
 * 
 *
 * Values: _0,_64,_128,_192
 */

enum class AnnotationType(val value: kotlin.Int) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is AnnotationType) "$data" else null

        /**
         * Returns a valid [AnnotationType] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): AnnotationType? = data?.let {
