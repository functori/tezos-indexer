 ...
 * @param content Affected key. If the action is `allocate` or `remove` the key will be `null`.
 */
...
data class BigMapDiff (
    ...
    /* Affected key. If the action is `allocate` or `remove` the key will be `null`. */
    @Json(name = "content")
