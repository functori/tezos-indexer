 ...
 * 
 *
 * @param path Full path to the Big_map in the contract storage
 * @param name Big_map name, if exists (field annotation)
 * @param keySchema JSON Schema of the Big_map key in humanified format (as returned by API)
 * @param valueSchema JSON Schema of the Big_map value in humanified format (as returned by API)
 */

data class BigMapInterface (
    ...
    @Json(name = "keySchema")
    val keySchema: OneOfLessThanObjectGreaterThan? = null,

    /* JSON Schema of the Big_map value in humanified format (as returned by API) */
    @Json(name = "valueSchema")
    val valueSchema: OneOfLessThanObjectGreaterThan? = null
