 ...
 * 
 *
 * @param address Global address (expression hash)
 * @param `value` Constant value (either micheline, michelson or bytes, depending on the `format` parameter)
 * @param propertySize Constant size in bytes
 * @param refs Number of contracts referencing this constant
 * @param creator Account registered this constant
 * @param creationLevel Level of the first block baked with this software
 * @param creationTime Datetime of the first block baked with this software
...
data class Constant (
    ...
    @Json(name = "creator")
    val creator: OneOfLessThanAliasGreaterThan? = null,
    ...
    /* Offchain metadata */
    @Json(name = "metadata")
    val metadata: OneOfLessThanObjectGreaterThan? = null
