...
import com.rarible.tezos.tzkt.models.DelegationOperationAllOf
import com.rarible.tezos.tzkt.models.Operation
import com.rarible.tezos.tzkt.models.OperationError
 ...
 * 
 *
 * @param type Type of the operation, `delegation` -  is used to delegate funds to a delegate (an implicit account registered as a baker)
 ...
 * @param initiator Information about the initiator of the delegation contract call
 * @param sender Information about the delegated account
 ...
 * @param bakerFee Fee to a baker, produced block, in which the operation was included
 * @param amount Sender's balance at the time of delegation operation (aka delegation amount).
 * @param prevDelegate Information about the previous delegate of the account. `null` if there is no previous delegate
...
data class DelegationOperation (
    ...
    @Json(name = "initiator")
    val initiator: OneOfLessThanAliasGreaterThan? = null,

    /* Information about the delegated account */
    @Json(name = "sender")
    val sender: OneOfLessThanAliasGreaterThan? = null,
    ...
    @Json(name = "prevDelegate")
    val prevDelegate: OneOfLessThanAliasGreaterThan? = null,
    ...
    @Json(name = "newDelegate")
    val newDelegate: OneOfLessThanAliasGreaterThan? = null,
