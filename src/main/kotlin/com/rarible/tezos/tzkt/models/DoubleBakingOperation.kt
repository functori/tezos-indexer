...
import com.rarible.tezos.tzkt.models.DoubleBakingOperationAllOf
 ...
 * 
 *
 * @param type Type of the operation, `double_baking` - is used by bakers to provide evidence of double baking (baking two different blocks at the same height) by a baker
 ...
 * @param accusedLevel The height of the block from the genesis block, which was double baked
 ...
 * @param offender Information about the baker (delegate), accused for producing two different blocks at the same height
...
data class DoubleBakingOperation (
    ...
    @Json(name = "accuser")
    val accuser: OneOfLessThanAliasGreaterThan? = null,
    ...
    @Json(name = "offender")
    val offender: OneOfLessThanAliasGreaterThan? = null,
