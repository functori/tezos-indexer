 ...
 * @param parameterSchema JSON Schema of the entrypoint parameter in humanified format (as returned by API)
 */

data class EntrypointInterface (
    ...
    @Json(name = "parameterSchema")
    val parameterSchema: OneOfLessThanObjectGreaterThan? = null
