 ...
 * @param `null` **Is null** filter mode. \\ Use this mode to get items where the specified field is null or not.  Example: `?nonce.null` or `?nonce.null=false`.
 */

data class Int32NullParameter (
    ...
    /* **Is null** filter mode. \\ Use this mode to get items where the specified field is null or not.  Example: `?nonce.null` or `?nonce.null=false`. */
    @Json(name = "null")
