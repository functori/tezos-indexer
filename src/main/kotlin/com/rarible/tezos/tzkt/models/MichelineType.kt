 ...
 * 
 *
 * Values: _0,_32,_64,_96,_128
 */

enum class MichelineType(val value: kotlin.Int) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is MichelineType) "$data" else null

        /**
         * Returns a valid [MichelineType] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): MichelineType? = data?.let {
