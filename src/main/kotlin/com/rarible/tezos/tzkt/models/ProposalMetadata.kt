 ...
 * 
 *
 * @param alias Alias name of the proposal
 * @param hash Hash of the proposal, which representing a tarball of concatenated .ml/.mli source files
 * @param agora Link to the proposal on Tezos Agora portall with full details
 * @param invoice Reward for the proposal developers, that will be generated if the proposal is accepted
 */
