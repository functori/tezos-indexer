...
import com.rarible.tezos.tzkt.models.PeriodInfo
import com.rarible.tezos.tzkt.models.ProposalAlias
import com.rarible.tezos.tzkt.models.ProposalOperationAllOf
 ...
 * 
 *
 * @param type Type of the operation, `proposal` - is used by bakers (delegates) to submit and/or upvote proposals to amend the protocol
 ...
 * @param period Information about the proposal period for which the proposal was submitted (upvoted)
 * @param proposal Information about the submitted (upvoted) proposal
 * @param `delegate` Information about the baker (delegate), submitted (upvoted) the proposal operation
 * @param rolls Number of baker's rolls (baker's voting power)
 * @param duplicated Indicates whether proposal upvote has already been pushed. Duplicated proposal operations are not counted when selecting proposal-winner.
 * @param quote Injected historical quote at the time of operation
 */

data class ProposalOperation (
    ...
    @Json(name = "period")
    val period: OneOfLessThanPeriodInfoGreaterThan? = null,

    /* Information about the submitted (upvoted) proposal */
    @Json(name = "proposal")
    val proposal: OneOfLessThanProposalAliasGreaterThan? = null,
    ...
    val duplicated: kotlin.Boolean? = null,
