 ...
 * @param creationLevel Height of the block where the contract was created
 * @param creationTime Datetime of the block where the contract was created (ISO 8601, e.g. `2020-02-20T02:40:57Z`)
 */
