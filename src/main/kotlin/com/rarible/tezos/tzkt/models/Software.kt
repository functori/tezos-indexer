 ...
 * 
 *
 * @param shortHash Software ID (short commit hash)
 * @param firstLevel Level of the first block baked with this software
 * @param firstTime Datetime of the first block baked with this software
 * @param lastLevel Level of the last block baked with this software
 * @param lastTime Datetime of the last block baked with this software
 * @param blocksCount Total number of blocks baked with this software
...
data class Software (
    ...
    @Json(name = "shortHash")
    val shortHash: kotlin.String? = null,
    ...
    @Json(name = "blocksCount")
    val blocksCount: kotlin.Int? = null,
