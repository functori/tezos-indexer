...
import com.rarible.tezos.tzkt.models.SourceOperation
 ...
 * 
 *
 * @param id Id of the record that can be used for pagination
 * @param level Level at which the storage value was taken
 * @param timestamp Timestamp at which the storage value was taken
 * @param operation Operation that caused the storage change
...
data class StorageRecord (
    ...
    @Json(name = "operation")
    val operation: OneOfLessThanSourceOperationGreaterThan? = null,
