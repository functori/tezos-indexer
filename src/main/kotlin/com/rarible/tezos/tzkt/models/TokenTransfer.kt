...
import com.rarible.tezos.tzkt.models.TokenInfo
...
data class TokenTransfer (
    ...
    @Json(name = "token")
    val token: OneOfLessThanTokenInfoGreaterThan? = null,

    /* Sender account.   Click on the field to expand more details. */
    @Json(name = "from")
    val from: OneOfLessThanAliasGreaterThan? = null,

    /* Target account.   Click on the field to expand more details. */
    @Json(name = "to")
    val to: OneOfLessThanAliasGreaterThan? = null,
