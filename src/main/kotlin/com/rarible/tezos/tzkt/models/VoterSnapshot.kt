 ...
 * 
 *
 * @param `delegate` Voter identity
 * @param rolls Voter's rolls snapshot (aka voting power)
 * @param status Voter's status: `none` - the voter did nothing `upvoted` - the voter upvoted at least one proposal `voted_yay` - the voter voted \"yay\" `voted_nay` - the voter voted \"nay\" `voted_pass` - the voter voted \"pass\"
 */

data class VoterSnapshot (
