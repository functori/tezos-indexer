 ...
 * 
 *
 * @param type Delegator type ('contract' for KT.. address or 'user' for tz.. address)
 * @param alias Name of the project behind the account or account description
 * @param address Public key hash of the account
 * @param balance Account balance (micro tez)
 * @param delegationLevel Block height of last delegation operation
 * @param delegationTime Block datetime of last delegation operation (ISO 8601, e.g. `2020-02-20T02:40:57Z`)
 */
