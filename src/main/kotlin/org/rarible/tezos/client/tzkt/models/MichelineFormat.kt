 ...
 * 
 *
 * Values: json,jsonString,raw,rawString
 */

enum class MichelineFormat(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is MichelineFormat) "$data" else null

        /**
         * Returns a valid [MichelineFormat] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): MichelineFormat? = data?.let {
