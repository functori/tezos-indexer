...
data class NatParameter (
    ...
    /* **Equal** filter mode (optional, i.e. `param.eq=123` is the same as `param=123`). \\ Specify a `nat` value to get items where the specified field is equal to the specified value.  Example: `?balance=1234`. */
    @Json(name = "eq")
    val eq: kotlin.String? = null,

    /* **Not equal** filter mode. \\ Specify a `nat` value to get items where the specified field is not equal to the specified value.  Example: `?balance.ne=1234`. */
    @Json(name = "ne")
    val ne: kotlin.String? = null,

    /* **Greater than** filter mode. \\ Specify a `nat` value to get items where the specified field is greater than the specified value.  Example: `?balance.gt=1234`. */
    @Json(name = "gt")
    val gt: kotlin.String? = null,

    /* **Greater or equal** filter mode. \\ Specify a `nat` value to get items where the specified field is greater than equal to the specified value.  Example: `?balance.ge=1234`. */
    @Json(name = "ge")
    val ge: kotlin.String? = null,

    /* **Less than** filter mode. \\ Specify a `nat` value to get items where the specified field is less than the specified value.  Example: `?balance.lt=1234`. */
    @Json(name = "lt")
    val lt: kotlin.String? = null,

    /* **Less or equal** filter mode. \\ Specify a `nat` value to get items where the specified field is less than or equal to the specified value.  Example: `?balance.le=1234`. */
    @Json(name = "le")
    val le: kotlin.String? = null,

    /* **In list** (any of) filter mode. \\ Specify a comma-separated list of `nat` values to get items where the specified field is equal to one of the specified values.  Example: `?level.in=12,14,52,69`. */
    @Json(name = "in")
    val `in`: kotlin.collections.List<kotlin.String>? = null,

    /* **Not in list** (none of) filter mode. \\ Specify a comma-separated list of `nat` values to get items where the specified field is not equal to all the specified values.  Example: `?level.ni=12,14,52,69`. */
    @Json(name = "ni")
