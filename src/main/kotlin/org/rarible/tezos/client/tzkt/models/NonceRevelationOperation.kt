...
import org.rarible.tezos.client.tzkt.models.NonceRevelationOperationAllOf
 ...
 * 
 *
 * @param type Type of the operation, `nonce_revelation` - are used by the blockchain to create randomness
 ...
 * @param baker Information about the delegate (baker), who produced the block with the operation
 * @param bakerRewards Reward amount paid to baker, included this operation into a block
 * @param sender Information about the delegate (baker), who revealed the nonce (sent the operation)
 * @param revealedLevel Block height of the block, where seed nonce hash is stored
 * @param quote Injected historical quote at the time of operation
 */

data class NonceRevelationOperation (
    ...
    @Json(name = "bakerRewards")
    val bakerRewards: kotlin.Long? = null,
    ...
    @Json(name = "revealedLevel")
    val revealedLevel: kotlin.Int? = null,
