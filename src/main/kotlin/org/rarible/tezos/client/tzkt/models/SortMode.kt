...
enum class SortMode(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is SortMode) "$data" else null

        /**
         * Returns a valid [SortMode] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): SortMode? = data?.let {
