 ...
 * 
 *
 * Values: none,btc,eur,usd,cny,jpy,krw,eth,gbp
 */

enum class Symbols(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is Symbols) "$data" else null

        /**
         * Returns a valid [Symbols] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): Symbols? = data?.let {
